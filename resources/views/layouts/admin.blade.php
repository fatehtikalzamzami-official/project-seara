...
<head>
    ...
    <title>@yield('title', 'Panel Admin') – SEARA</title>
    ...
    <style>
        ...
        *::after {
        ...
        .nav-item.active {
            background: linear-gradient(90deg, rgba(61, 186, 126, .22), rgba(61, 186, 126, .08));
            color: var(--accent2);
        }
        ...
        .search-wrap:focus-within {
            ...
            box-shadow: 0 0 0 3px rgba(61, 186, 126, .12);
        }
        ...
        .icon-btn:hover {
            border-color: var(--accent);
            box-shadow: 0 0 0 3px rgba(61, 186, 126, .1);
        }
    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('admin.laporan') }}"
                    ...
                    <div class="nav-badge">@yield('laporan_badge', '24')</div>
        ...
        <div class="main">
            ...
            <div class="topbar">
                ...
                {{-- Search slot: tiap halaman bisa override via @section('topbar_search') --}}
                @hasSection('topbar_search')
                    @yield('topbar_search')
                @else
        ...
        {{-- ── LOGOUT MODAL ── --}}
        <div class="logout-modal" id="logoutModal" onclick="if(event.target===this)closeLogoutModal()">
            <div class="logout-modal-inner">
                <div style="text-align:center;margin-bottom:20px">
                    ...
                    <div style="font-size:17px;font-weight:800;color:#1a2e24;margin-bottom:6px">
                        Keluar dari Panel Admin?
                    </div>
                    <div style="font-size:13px;color:#7a9488;font-weight:500">
                        Sesi Anda akan diakhiri. Pastikan semua pekerjaan sudah tersimpan.
                    </div>
                </div>
                <div style="display:flex;gap:10px">
                    <button onclick="closeLogoutModal()" style="flex:1;padding:11px;border-radius:12px;border:1.5px solid #e8eeeb;
                           background:#fff;font-family:'Plus Jakarta Sans',sans-serif;
                           font-size:13px;font-weight:700;color:#7a9488;cursor:pointer"
                    ...
                    <button onclick="document.getElementById('adminLogoutForm').submit()" style="flex:1;padding:11px;border-radius:12px;border:none;background:#e05c5c;
                           font-family:'Plus Jakarta Sans',sans-serif;
