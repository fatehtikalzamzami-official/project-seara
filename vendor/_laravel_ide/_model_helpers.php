...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule forSeller() {@see App\Models\HarvestSchedule::scopeForSeller()}
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule upcoming() {@see App\Models\HarvestSchedule::scopeUpcoming()}
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule byStatus(string $status) {@see App\Models\HarvestSchedule::scopeByStatus()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
