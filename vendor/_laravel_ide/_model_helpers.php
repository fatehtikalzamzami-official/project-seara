...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $minimal_pembelian
     * @property float|null $berat_bersih
     * @property string|null $kondisi_produk
     * @property int|null $masa_simpan_hari
     * @property string|null $metode_tanam
     * @property string|null $kebun_lokasi
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereKebunLokasi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereMetodeTanam($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereMasaSimpanHari($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereKondisiProduk($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereBeratBersih($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Harvest>|Harvest whereMinimalPembelian($value)
    ...
    /**
     * App\Models\HarvestSchedule
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property boolean $is_organic
     ...
     * @property float|null $estimasi_kuantitas
     * @property \Illuminate\Support\Carbon $estimasi_panen
     * @property \Illuminate\Support\Carbon|null $tanggal_tanam
     ...
     * @property-read mixed $sisa_hari
     * @property-read mixed $progress
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Category $category
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereCategoryId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereNamaTanaman($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereTanggalTanam($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereEstimasiPanen($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereEstimasiKuantitas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereSatuan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereKebunLokasi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereMetodeTanam($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereCatatan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereLuasLahan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereIsOrganic($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule query()
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule forSeller(mixed $userId = null) {@see App\Models\HarvestSchedule::scopeForSeller()}
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule active() {@see App\Models\HarvestSchedule::scopeActive()}
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule upcoming(int $days = 7) {@see App\Models\HarvestSchedule::scopeUpcoming()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<HarvestSchedule>|HarvestSchedule timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class HarvestSchedule extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report reviewing() {@see App\Models\Report::scopeReviewing()}
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report resolved() {@see App\Models\Report::scopeResolved()}
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report dismissed() {@see App\Models\Report::scopeDismissed()}
     * @method static \Illuminate\Database\Eloquent\Builder<Report>|Report active() {@see App\Models\Report::scopeActive()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
